...
REQUEST_ADDRESS = ('localhost', 50000) #50403
REQUEST_SIZE = 12
...
class TestPublisher(object):
    ...
    def __init__(self):
        ...
        print("read write socket created \n")#######################################
    ...
    def publish(self):
        ...
        for subscriber in self.subscriptions:
            ...
            print("Sending publisher message\n")#################################
